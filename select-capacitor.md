...
<details><summary>主な使い方</summary>
  自分が知っている限りでは、昇圧チョッパやオペアンプ回路...というかう使わない回路見ない感じに多くの回路に使われている。
 ...
 <details><summary>バイパスコンデンサ</summary>
  バイパスコンデンサとは、ノイズ対策にマイコンの近くに置くコンデンサのことです。
  また、電圧の変動やICに必要な電源の補充の役割も担ってます。
  過電流が流れるのを防いでくれたりしています。
  だいたい0.01u～0.1uくらいをいれます（自分は0.1u）
  場所としては、電源の入力元や、電圧変換機構の入出力、ICのピンの近くに入れます。
